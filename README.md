...
- Podemos definir o estilo para todos componentes atraves do atributo *theme*
```jsx
...
```
- Aqui esta o estilo que todos componentes estão recebendo:
...
```
- E depois é só chamar o estilo nos arquivos que estão dentro da TAG:
```jsx
